...
type ComplexityRoot struct {
	Category struct {
		Curses      func(childComplexity int) int
...
type CategoryResolver interface {
	Curses(ctx context.Context, obj *model.Category) ([]*model.Course, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Category.curses":
		if e.complexity.Category.Curses == nil {
			break
		}

		return e.complexity.Category.Curses(childComplexity), true
...
func (ec *executionContext) field_Mutation_createCategory_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewCategoryInput2graphQLᚋgraphᚋmodelᚐNewCategoryInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createCourse_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewCourseInput2graphQLᚋgraphᚋmodelᚐNewCourseInput(ctx, tmp)
	}
...
func (ec *executionContext) _Category_curses(ctx context.Context, field graphql.CollectedField, obj *model.Category) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Category_curses(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Category().Curses(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Category_curses(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Category",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) fieldContext_Course_category(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "curses":
				return ec.fieldContext_Category_curses(ctx, field)
			}
	...
	for i, field := range fields {
		...
		case "curses":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Category_curses(ctx, field, obj)
				if res == graphql.Null {
...
func (ec *executionContext) unmarshalNNewCategoryInput2graphQLᚋgraphᚋmodelᚐNewCategoryInput(ctx context.Context, v any) (model.NewCategoryInput, error) {
	res, err := ec.unmarshalInputNewCategoryInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewCourseInput2graphQLᚋgraphᚋmodelᚐNewCourseInput(ctx context.Context, v any) (model.NewCourseInput, error) {
